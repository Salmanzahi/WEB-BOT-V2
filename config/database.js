...
let localData = {
  ...
  market: {
    ...
    lastUpdate: Double,
    commodities: Object,
    lastCommUpdate: Double,
    forex: Object,
    lastForexUpdate: Double,
    miningPrices: Object,
    lastMiningUpdate: Double,
  },
  settings: Object,
  // Data tambahan untuk web
  webUsers: Object, // username->password mapping
  chatRooms: Object, // room chat
  privateChats: Object, // DM antar user
  nations: Object,
  matches: Object,
  stockMarket: Object,
  factories: Object,
...
function getDB() {
  if (!_db)
    throw new Error("Database belum terhubung. Panggil connectDB() dulu.");
  return _db;
}
...
async function loadData() {
  try {
    ...
    console.log(
      `📥 Data dimuat: ${Object.keys(localData.users).length} WA users, ${Object.keys(localData.webUsers).length} web users`,
    );
  } catch (err) {
...
function getWebUsers() {
  return localData.webUsers || {};
}
function getSettings() {
  return localData.settings || {};
}
function getChatRooms() {
  return localData.chatRooms || {};
}
function getPrivateChats() {
  return localData.privateChats || {};
}
